...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250206085626_WorkspaceTBL")]
    partial class WorkspaceTBL
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.WorkSpace.Workspace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("InternalOrView")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsSubcategoryShared")
                        .HasColumnType("bit");
                    ...
                    b.Property<long?>("WorkspaceSubcategoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("WorkspaceSubcategoryId");

                    b.ToTable("workspaces");
                });

            modelBuilder.Entity("Domain.WorkSpace.WorkspacePriceCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("workspacePriceCategories");
                });

            modelBuilder.Entity("Domain.WorkSpace.WorkspaceSubcategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("SubscriptionMechanism")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("workspaceSubcategories");
                });
            ...
            modelBuilder.Entity("Domain.WorkSpace.Workspace", b =>
                {
                    b.HasOne("Domain.Lookup", "WorkspaceCategory")
                        .WithMany()
                        .HasForeignKey("WorkspaceCategoryId");

                    b.HasOne("Domain.WorkSpace.WorkspaceSubcategory", "WorkspaceSubcategory")
                        .WithMany()
                        .HasForeignKey("WorkspaceSubcategoryId");

                    b.Navigation("WorkspaceCategory");

                    b.Navigation("WorkspaceSubcategory");
                });
