...
import { Card2Component } from "src/app/_metronic/partials/content/cards/card2/card2.component";
import { IconUserModel } from "src/app/_metronic/partials/content/cards/icon-user.model";
