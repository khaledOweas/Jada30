...
import { BooleanBaseResponse, GetLookupDto, GetLookupDtoListBaseResponse, LookupService } from "src/app/services/LookupService";
    ...
    delete(id: string) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          try {
            this.service.deleteLookup(id).subscribe({
