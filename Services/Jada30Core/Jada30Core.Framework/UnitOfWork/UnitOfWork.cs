using Jada30Core.Framework.Repository;
...
namespace Jada30Core.Framework.UoW
{
    /// <summary>
    ...
    public class UnitOfWork : IRepositoryFactory, IUnitOfWork
    {
        ...
        public UnitOfWork(Jada30CoreContext context)
        {
        ...
        public Jada30CoreContext DbContext { get; }
