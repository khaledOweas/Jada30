...
export class CoreService {
    ...
    branchGET(): Observable<GetBranchDtoListBaseResponse> {
        let url_ = this.baseUrl + "/api/Data/Endpoint2";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    branchGET2(id: number): Observable<any> {
        let url_ = this.baseUrl + "/api/Data/Endpoint11?param1={id}";
    ...
    protected processBranchGET2(response: HttpResponseBase): Observable<any> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    eventPOST(body: CreateEventDto | undefined): Observable<GetEventDtoBaseResponse> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetEventDtoBaseResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetEventDtoBaseResponse>;
        }));
    }

    protected processEventPOST(response: HttpResponseBase): Observable<GetEventDtoBaseResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = GetEventDtoBaseResponse.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    eventGET(): Observable<GetEventDtoListBaseResponse> {
        let url_ = this.baseUrl + "/Event/GetEvents";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetEventDtoListBaseResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetEventDtoListBaseResponse>;
        }));
    }

    protected processEventGET(response: HttpResponseBase): Observable<GetEventDtoListBaseResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = GetEventDtoListBaseResponse.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    eventGET2(id: number): Observable<GetEventDtoBaseResponse> {
        let url_ = this.baseUrl + "/Event/GetEvent/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processEventGET2(response: HttpResponseBase): Observable<GetEventDtoBaseResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    eventPUT(id: number, body: CreateEventDto | undefined): Observable<GetEventDtoBaseResponse> {
    ...
    protected processEventPUT(response: HttpResponseBase): Observable<GetEventDtoBaseResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    eventDELETE(id: number): Observable<BooleanBaseResponse> {
        let url_ = this.baseUrl + "/Event/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processEventDELETE(response: HttpResponseBase): Observable<BooleanBaseResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
                (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class CreateEventDto implements ICreateEventDto {
    ...
    endDate?: Date;
    isForJadah30Customers?: boolean;
    speakersNames?: string | undefined;
    numberSeats: number;
    socialMediaLinks: string | undefined;
    registrationForm?: boolean;
    isFreePaid?: boolean;
    mediaFiles?: CreateEventMediaFileDto[] | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.isForJadah30Customers = _data["isForJadah30Customers"];
            this.speakersNames = _data["speakersNames"];
            this.numberSeats = _data["numberSeats"];
            this.socialMediaLinks = _data["socialMediaLinks"];
            this.registrationForm = _data["registrationForm"];
            this.isFreePaid = _data["isFreePaid"];
            if (Array.isArray(_data["mediaFiles"])) {
                this.mediaFiles = [] as any;
                for (let item of _data["mediaFiles"])
                    this.mediaFiles!.push(CreateEventMediaFileDto.fromJS(item));
            }
        }
    }
...
export class CreateEventMediaFileDto implements ICreateEventMediaFileDto {
    name?: string;
    path?: string;
    eventhId?: number;
    typeId?: number;

    constructor(data?: ICreateEventMediaFileDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.eventhId = _data["eventhId"];
            this.typeId = _data["typeId"];
        }
    }

    static fromJS(data: any): CreateEventMediaFileDto {
        data = typeof data === 'object' ? data : {};
        let result = new CreateEventMediaFileDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["name"] = this.name;
        data["path"] = this.path;
        data["eventhId"] = this.eventhId;
        data["typeId"] = this.typeId;
        return data;
    }
}

export interface ICreateEventMediaFileDto {
    name?: string;
    path?: string;
    eventhId?: number;
    typeId?: number;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["mediaFiles"])) {
                this.mediaFiles = [] as any;
                for (let item of _data["mediaFiles"])
                    this.mediaFiles!.push(GetPerkLicenseDto.fromJS(item));
            }
        }
    }
...
export class GetEventDtoBaseResponse implements IGetEventDtoBaseResponse {
    isSuccess?: boolean;
    version?: number;
    message?: string | undefined;
    responseData?: GetEventDto;
    errors?: Errors[] | undefined;
    statusCode?: number;

    constructor(data?: IGetEventDtoBaseResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.version = _data["version"];
            this.message = _data["message"];
            this.responseData = _data["responseData"] ? GetEventDto.fromJS(_data["responseData"]) : <any>undefined;
            if (Array.isArray(_data["errors"])) {
                this.errors = [] as any;
                for (let item of _data["errors"])
                    this.errors!.push(Errors.fromJS(item));
    ...
    static fromJS(data: any): GetEventDtoBaseResponse {
        data = typeof data === 'object' ? data : {};
        let result = new GetEventDtoBaseResponse();
        result.init(data);
        return result;
    }
...
export interface IGetEventDtoBaseResponse {
    isSuccess?: boolean;
    version?: number;
    message?: string | undefined;
    responseData?: GetPerkDto;
...
export class GetEventDtoListBaseResponse implements IGetEventDtoListBaseResponse {
    isSuccess?: boolean;
    version?: number;
    message?: string | undefined;
    responseData?: GetEventDto[] | undefined;
    errors?: Errors[] | undefined;
    statusCode?: number;

    constructor(data?: IGetEventDtoListBaseResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["responseData"])) {
                this.responseData = [] as any;
                for (let item of _data["responseData"])
                    this.responseData!.push(GetEventDto.fromJS(item));
            }
            if (Array.isArray(_data["errors"])) {
                this.errors = [] as any;
                for (let item of _data["errors"])
    ...
    static fromJS(data: any): GetEventDtoListBaseResponse {
        data = typeof data === 'object' ? data : {};
        let result = new GetEventDtoListBaseResponse();
        result.init(data);
        return result;
    }
...
export interface IGetEventDtoListBaseResponse {
    isSuccess?: boolean;
    version?: number;
    message?: string | undefined;
    responseData?: GetEventDto[] | undefined;
...
export class GetEventMediaFileDto implements IGetEventMediaFileDto {
    id?: number;
    name?: string | undefined;
    path?: string | undefined;
    eventTitle?: string | undefined;
    eventTitleAr?: string | undefined;
    typeName?: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.eventTitleAr = _data["eventTitleAr"];
            this.typeName = _data["typeName"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["eventTitleAr"] = this.eventTitleAr;
        data["typeName"] = this.typeName;
        return data;
    }
}

export interface IGetEventMediaFileDto {
    id?: number;
    name?: string | undefined;
    path?: string | undefined;
    eventTitle?: string | undefined;
