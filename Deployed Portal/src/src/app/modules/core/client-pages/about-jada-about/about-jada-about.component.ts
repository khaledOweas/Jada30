...
@Component({
  selector: "app-about-jada-about",
  standalone: true,
  imports: [ RouterLink, RouterLinkActive,  CommonModule,
    // JadaCardSystemServiceComponent, 
    CardModule, ButtonModule],
  templateUrl: "./about-jada-about.component.html",
  styleUrl: "./about-jada-about.component.scss",
  providers: [CoreService]
})
export class AboutJadaAboutComponent extends BaseComponent  {
