...
import { AboutJadaSuccessStoryComponent } from "../about-jada-success-story/about-jada.-success-story.component";
...
@Component({
  selector: "app-about-jada-success-stories",
  standalone: true,
  imports: [ RouterLink, RouterLinkActive,  CommonModule,
    AboutJadaSuccessStoryComponent,
    // JadaCardSystemServiceComponent, 
    CardModule, ButtonModule],
  templateUrl: "./about-jada-success-stories.component.html",
  styleUrl: "./about-jada-success-stories.component.scss",
  providers: [CoreService]
})
export class AboutJadaSuccessStoriesComponent extends BaseComponent implements OnInit  {
