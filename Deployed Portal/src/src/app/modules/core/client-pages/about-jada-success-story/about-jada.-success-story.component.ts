...
@Component({
  selector: "app-about-jada-success-story",
  standalone: true,
  imports: [ RouterLink, RouterLinkActive,  CommonModule,
    // JadaCardSystemServiceComponent, 
    CardModule, ButtonModule],
  templateUrl: "./about-jada-success-story.component.html",
  styleUrl: "./about-jada-success-story.component.scss",
  providers: [CoreService]
})
export class AboutJadaSuccessStoryComponent extends BaseComponent  {
