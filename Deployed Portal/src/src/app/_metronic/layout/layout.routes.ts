...
export const LAYOUT_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      {
        path: "event",
        loadChildren: () => import("../../modules/Routes/event.routes").then((m) => m.EVENT_ROUTES)
      },
      {
        path: "client-pages",
        loadChildren: () => import("../../modules/Routes/client-pages.routes").then((m) => m.CLIENTPAGES_ROUTES)
      },
      {
        path: "",
