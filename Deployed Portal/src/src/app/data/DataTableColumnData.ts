...
export class ColumnManager {
  ...
  private static getEventColumns(): SharedDataTableColumn[] {
    return [
      SharedDataTableColumn.fromJS({
        id: 1,
        sorted: true,
      ...
      SharedDataTableColumn.fromJS({
        ...
        filtered: true,
        hidden: false,
        field: this.perLang("titleAr", "title"),
        header: ColumnManager.tr!.get("Events.Title"),
        type: "text"
      }),
      ...
      SharedDataTableColumn.fromJS({
        ...
        hidden: false,
        field: "duration",
        header: ColumnManager.tr!.get("Events.duration"),
        type: "text"
      }),
      ...
      SharedDataTableColumn.fromJS({
        ...
        hidden: false,
        field: "startDate",
        header: ColumnManager.tr!.get("Events.startDate"),
        type: "text"
      }),
      ...
      SharedDataTableColumn.fromJS({
        ...
        hidden: false,
        field: "endDate",
        header: ColumnManager.tr!.get("Events.endDate"),
        type: "datetime"
      }),
      ...
      SharedDataTableColumn.fromJS({
        ...
        filtered: true,
        hidden: false,
        field: "isForJadah30Customers",
        header: ColumnManager.tr!.get("Events.isForJadah30Customers"),
        type: "datetime"
      }),
      ...
      SharedDataTableColumn.fromJS({
        ...
        hidden: false,
        field: "speakersNames",
        header: ColumnManager.tr!.get("Events.speakersNames"),
        type: "text"
      }),
      SharedDataTableColumn.fromJS({
        id: 8,
        ...
        hidden: false,
        field: "numberSeats",
        header: ColumnManager.tr!.get("Events.numberSeats"),
        type: "text"
      }),
      SharedDataTableColumn.fromJS({
        id: 8,
        ...
        header: ColumnManager.tr!.get("Events.socialMediaLinks"),
        type: "text"
      }),
      SharedDataTableColumn.fromJS({
        id: 8,
        ...
        header: ColumnManager.tr!.get("Events.registrationForm"),
        type: "text"
      }),
      SharedDataTableColumn.fromJS({
        id: 8,
        ...
        hidden: false,
        field: "isFreePaid",
        header: ColumnManager.tr!.get("Events.isFreePaid"),
        type: "text"
      })
